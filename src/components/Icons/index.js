...
export const ActiveLibraryIcon = ({ className }) => (
    <svg className={className} height="24" width="24" viewBox="0 0 24 24">
...
export const ArrowToRightIcon = ({ className }) => (
    <svg className={className} height="16" width="16" viewBox="0 0 16 16">
...
export const ArrowToLeftIcon = ({ className }) => (
    <svg className={className} height="16" width="16" viewBox="0 0 16 16">
...
export const MoreOptionsIcon = ({ className }) => (
    <svg
        className={className}
        height="16"
        width="16"
...
export const VolumeLowIcon = ({ className }) => (
    <svg
        className={className}
        height="16"
        width="16"
...
export const PlayingIcon = ({ className }) => (
    <svg
        className={className}
